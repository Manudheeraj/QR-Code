...
class QRCodeGenerator:
    ...
    def _init_(self, box_size=10, border=4):
        """
        ...
        try:
            ...
            if url:
                return {
                    ...
                    'url': url,
                    'service': 'file.io',
                    'message': '⚠ Link expires after FIRST download or 14 days'
                }
        except Exception as e:
    ...
    def _upload_to_pixeldrain(self, file_bytes, filename):
        ...
        response = requests.post(
            'https://pixeldrain.com/api/file', files=files, timeout=60)
    ...
    def _upload_to_gofile(self, file_bytes, filename):
        ...
        server_response = requests.get(
            'https://api.gofile.io/getServer', timeout=10)
